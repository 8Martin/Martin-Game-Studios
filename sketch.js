...
// Interior Of the ship //
  ...
  e2 = createSprite(windowWidth/2-200,e1.y+1500,20,20);
  e2.addImage("e2",e2Img);
  e2.scale = 2.8;

  e3 = createSprite(windowWidth/2-200,e2.y+1500,20,20);
  e3.addImage("e3",e3Img);
  e3.scale = 3.2;
 
  e4 = createSprite(windowWidth/2-200,e3.y+1500,20,20);
  e4.addImage("e4",e4Img);
  e4.scale = 3;
  
  e5 = createSprite(windowWidth/2-200,e4.y+1500,20,20);
  e5.addImage("e5",e5Img);
  e5.scale = 3.2;
 
  e6 = createSprite(windowWidth/2-200,e5.y+1500,20,20);
  e6.addImage("e6",e6Img);
  e6.scale = 4.3;
  
  e7 = createSprite(windowWidth/2-200,e6.y+1500,20,20);
...
// MAIN //
 ...
 fill("white");
 textSize(80);
 text("Thank you for playing my Game,Hope you enjoyed it!",windowWidth/2-630,windowHeight/2);
 text("Hope you enjoyed it!",windowWidth/2-630,windowHeight/2+160);
 }
